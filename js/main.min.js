...
$(document).ready(function () {
    ...
    var accContent = document.querySelectorAll(".dashboard__sidebar > ul > li > ul");
    var i;
    ...
    /* const accordionBtns = document.querySelectorAll(".none");
    ...
    if (modalAdd) {
        ...
        let modalAddSelectsInner = modalAdd.getElementsByClassName("select2-selection--single");
        ...
        function formValidation() {
            ...
            if (isValid) {
                /* move on to the second stage if valid equals true*/
    ...
    if (modalPrice) {
        function inputs() {
            ...
            let modalAddTotalInner = modalPrice.querySelectorAll(".modal__add-total__inner");
    ...
    $("select").each(function () { initializeSelect2($(this)); });
