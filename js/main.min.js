  ...
  if (modalAdd) {
    ...
    function formValidation() {
      ...
      modalAddElements.forEach((element) => {
        modalRadioButtons.forEach((btn) => {
          if (element.value.trim() === "" || element.value.trim() === "0" || element.validity.typeMismatch || btn.checked.length === 0) {
            isValid = false;
          }
        })
      ...
      if (isValid) {
        ...
        /* Radio Buttons */
        console.log(modalRadioButtons.checked.length === 0);
