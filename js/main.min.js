...
$(document).ready(function () {
  ...
  var acc = document.querySelectorAll(".dashboard__sidebar > ul > li > a");
  var accContent = document.querySelectorAll(
    ".dashboard__sidebar > ul > li > ul"
  );
  var i;
  ...
  const container = document.querySelector('.dashboard__sidebar > ul');

  // Add a class to the container to apply CSS styles
  ...
  $(".close").click(() => {
    ...
    let modalInnerActives = modal.querySelectorAll(".active");
    modalInnerActives.forEach((active) => {
  ...
  /* Close modal on click on outside of the modal */
  window.onclick = function (event) {
    if (event.target == modal) {
      let modalActive = modal.querySelector('.active');
      if (modalActive.contains(modalInfo)) {
  ...
  /****** Modal form validation and calculator ******/
  ...
  if (modalAdd) {
    ...
    let modalAddSelectsInner = modalAdd.getElementsByClassName("select2-selection--single"); /* Plugin's select */
    ...
    function format(item) {
      var sanitizedValue = item.value.replace(/[^0-9+]/g, "");
      item.value = sanitizedValue;
    }

    /* input type text that will accept only numbers and plus sign*/
    if (modalAddPhone) {
      modalAddPhone.addEventListener("input", function () {
        format(modalAddPhone);
      });
    }


    /* Function for validation when next button is clicked */
    function formValidation() {
      let modalAddElements = modalAdd.querySelectorAll("input, select, textarea");
      let modalRadioButtons = modalAdd.querySelectorAll("input[type='radio']");

      let modalRadioButtonsChecked = false;

      let isValid = true;

      /* Pipe to check wether elements are valid */
      modalAddElements.forEach((element) => {
        if (element.value.trim() === "" || element.value.trim() === "0" || element.validity.typeMismatch) {
          isValid = false;
        }

        for (let i = 0; i < modalRadioButtons.length; i++) {
          if (modalRadioButtons[i].checked) {
            modalRadioButtonsChecked = true;
            break;
          }
        }
      });
      ...
      if (isValid) {
        /* Second stage active if isValid is true */
        ...
        /* Additional conditions inside the foreach is for removing or adding the border color when "next" button clicked */
        /* Input */
        ...
        /* Radio Buttons */
        if (!modalRadioButtonsChecked) {
          for (let i = 0; i < modalRadioButtons.length; i++) {
            modalRadioButtons[i].parentNode.style.borderColor = "red";
          }
        } else {
          for (let i = 0; i < modalRadioButtons.length; i++) {
            modalRadioButtons[i].parentNode.style.borderColor = null;
          }
        }
    ...
    let scheduleListItems = document.querySelectorAll('.schedule__list-add__inner-item');

    scheduleListItems.forEach((item) => {
      let checkboxes = item.querySelectorAll('input[type="checkbox"]');
      let inputTimes = item.querySelectorAll('input[type="time"]');
  ...
  if (modalPrice) {
    function inputs() {
      ...
      let modalAddDiscount = modalPrice.querySelectorAll(
        ".modal__add-discount"
      );
      ...
      modalAddDiscount.forEach((discountInput, index) => {
        ...
        discountInput.addEventListener("input", () => {
          if (discountInput.value > 100) {
            ...
            alert("Скидка не может быть минусовой");
            discountInput.value = "";
          }
        });
        /* Change */
        discountInput.addEventListener("change", () => {
          let priceValue = Number(
            modalAddPrice[index].value.replaceAll(" ", "")
          );
    ...
    $(".modal__add-calc__inner").on("click", ".item-add", function () {
      let item = `
            <div class="row modal__add-calc__inner-item">
                <div class="col-md-2">
                    <select name="" id="" required>
                        <option value="0">Select</option>
                        <option value="1">One to two</option>
                        <option value="2">Two to three</option>
                    </select>
                </div>
                <div class="col-md-2">
                    <select name="" id="" required>
                        <option value="0">Select</soption>
                        <option value="1">One to two</option>
                        <option value="2">Two to three</option>
                    </select>
                </div>
                <div class="col-md-2">
                    <input class="modal__add-price" type="text">
                </div>
                <div class="col-md-2">
                    <input class="modal__add-discount" type="text">
                </div>
                <div class="col-md-2">
                    <input class="modal__add-total__inner" text="text" disabled>
                </div>
                <div class="col-md-2">
            ...
            `;
      $(".modal__add-calc__inner").append(item);
    ...
    $(".modal__add-calc__inner").on("click", ".item-remove", function () {
      if ($(".item-add").length <= 1) {
        console.log("we can't do that sorry");
      } else {
    ...
    /*  let listItem = document.querySelectorAll('.modal__add-calc__inner-item'); */
  }
